...
elseif (IOS_PLATFORM STREQUAL "SIMULATOR64")
    # set (IOS_ARCH x86_64)
    set (IOS_ARCH x86_64)
    set (CMAKE_XCODE_ATTRIBUTE_ARCHS[sdk=iphonesimulator*] ${IOS_ARCH} CACHE string  "Build architecture for iOS")
    set (CMAKE_XCODE_ATTRIBUTE_VALID_ARCHS[sdk=iphonesimulator*] ${IOS_ARCH} CACHE string  "Build architecture for iOS")
elseif (IOS_PLATFORM STREQUAL "SIMULATOR")
    set (IOS_ARCH i386)
    set (CMAKE_XCODE_ATTRIBUTE_ARCHS[sdk=iphonesimulator*] ${IOS_ARCH} CACHE string  "Build architecture for iOS")
    set (CMAKE_XCODE_ATTRIBUTE_VALID_ARCHS[sdk=iphonesimulator*] ${IOS_ARCH} CACHE string  "Build architecture for iOS")
