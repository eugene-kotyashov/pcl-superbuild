  ...
  , camera_file_loaded_ (false)
{
  ...
  win_ = vtkSmartPointer<vtkIOSRenderWindow>::New ();
...
#else
  //interactor_ = vtkSmartPointer<vtkIOSRenderWindowInteractor>::New ();
  interactor_ = vtkSmartPointer <vtkIOSRenderWindowInteractor>::Take (vtkIOSRenderWindowInteractorFixNew ());
#endif
...
pcl::visualization::PCLVisualizer::setupInteractor (
  vtkIOSRenderWindowInteractor *iren,
  vtkIOSRenderWindow *win)
{
...
/////////////////////////////////////////////////////////////////////////////////////////////
void
pcl::visualization::PCLVisualizer::addOrientationMarkerWidgetAxes (vtkIOSRenderWindowInteractor* interactor)
{
  if ( !axes_widget_ )
  {
                                                               ...
                                                               float view_angle, float radius_sphere, bool use_vertices)
{
  ...
  vtkSmartPointer<vtkIOSRenderWindow> render_win = vtkSmartPointer<vtkIOSRenderWindow>::New ();
